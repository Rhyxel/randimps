...
charadex.site = {
  title: "Randimps",
  url: "https://rhyxel.github.io/randimps/",
  description: `The Randimps masterlist and inventories`
}
...
charadex.sheet = {
  ...
  id: "1jW-eLKst9lRbFb8I_zV_oxYWiNrLSzia-BvZ_C4_dOI",
  ...
  options: {
    ...
    designTypes: ['All', 'Gacha', 'Encounter', 'Custom', 'Event'],
    statuses: ['All', 'Rollable', 'Owned'],
    rarity: ['All', 'Common', 'Odd', 'Peculiar'],
    species: ['All', 'Randimp'],
    itemTypes: ['All', 'Currency', 'Bait', 'Alterations', 'Awards'],
